...
func main() {
	...
	newClient := Client{
		FIO:      "Иванов Иван Иванович", // укажите ФИО
		Login:    "ivanovS",              // укажите логин
		Birthday: "19990207",             // укажите день рождения
		Email:    "ivanovS@gmail.com",    // укажите почту
	}
	...
	newLogin := "ivanovFresh" // укажите новый логин
